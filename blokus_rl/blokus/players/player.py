...
class Player:
    """Main class for a player in the game of Blokus."""

    def __init__(
        self,
        index: int,
        name: str,
        all_moves: list[Shape],
        game: BlokusGame,
        deterministic=False,
    ):
        ...
        Args:
            ...
            game: A BlokusGame object.
            deterministic: A boolean representing whether the player should be \
    ...
    def possible_moves_opt(self):
        ...
        for moves in self.all_labels_to_move.values():
            placements.extend(
                move for move in moves if self.game.valid_move(self, move)
            )
        return placements
        ...
        def check_corners(no_restriction):
            ...
            if no_restriction:
                ...
                self.corners = {
                    ...
                    if self.game.board.tensor[j][i] == 0
                }
